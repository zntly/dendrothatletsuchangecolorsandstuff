...
local function DrawText(self)
    ...
    TextDrawing.Text, TextDrawing.Font, TextDrawing.Size, TextDrawing.Color = Text, Font, Size, self.PleaseBecomeThisColor;
...
function ESPs.BoundingBox:Render()
    local Thicknes, Opacity, Color = self.Thickness, self.Opacity, self.PleaseBecomeThisColor;
...
function ESPs.Orthogonal:Render()
    ...
    local Transparency, Color, Material = 1 - self.Opacity, self.PleaseBecomeThisColor, self.Material;
